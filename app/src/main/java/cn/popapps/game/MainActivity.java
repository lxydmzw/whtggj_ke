...
import cn.popapps.ws.JWebSocketBridge;
...
//        mPlugin.game_plugin_set_option("gameUrl", "http://132.232.5.166/H5GAME/1019/index.js");
    ...
    public void onActivityResult(int requestCode, int resultCode,Intent intent) {
        ...
        {
            ExportJavaFunction.CallBackToJS(JSBridge.class, "migu",  "close");
        }
    }
